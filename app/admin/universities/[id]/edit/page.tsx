...
export default async function EditUniversityPage({ params: { id } }: Props) {
  ...
  const { parseTuitionOptionsJson } = await import('@/lib/types/tuition');
  ...
  const defaultValues: UniversityFormDefaults = {
    ...
    acceptance_rate_min: u.acceptance_rate_min != null ? String(Number(u.acceptance_rate_min)) : '',
    acceptance_rate_max: u.acceptance_rate_max != null ? String(Number(u.acceptance_rate_max)) : '',
